    ...
    <div class="card shadow">
        <div class="card-header py-3">
            <p class="text-primary m-0 font-weight-bold">Data Pesanan</p>
                  ...
                  <select name="sort" id="sort" style="background-color:whitesmoke; border-style: none">
                  
                  <option disabled selected> Urutkan </option>
                            <option value="/Pesanan" onclick="sorting()">ID</option> 
                            <option value="/Pesanan/sort" onclick="sorting()">Tanggal</option> 
                            <option value="/Pesanan/sortkat" onclick="sorting()">Kategori</option> 
                            </select>
                            
                            <script>
                            function sorting() { 
                                var url = document.getElementById("sort").value;
